...
const WEAPONS := {
	...
	"chainbolt": {
		"name": "Lynkjede", "behavior": "chain", "tag": "shock",
		"damage": 10.0, "cooldown": 1.0, "range": 110.0, "speed": 0.0,
		"count": 3, "pierce": 0, "spread": 0.0, "sprite": "",
		"desc": "Hopper mellom fiender, svakere for hvert hopp. Rekker lenger fra nedkjølte mål.",
		"levels": [
			{"desc": "+2 hopp", "count_add": 2},
			{"desc": "+40 % skade", "damage_mul": 0.40},
			{"desc": "+30 % rekkevidde", "range_mul": 0.30},
			{"desc": "+2 hopp", "count_add": 2},
			{"desc": "+50 % skade", "damage_mul": 0.50},
		]},
	"flamethrower": {
		"name": "Flammekaster", "behavior": "cone", "tag": "fire",
		"damage": 5.0, "cooldown": 0.35, "range": 60.0, "speed": 0.0,
		"count": 1, "pierce": 99, "spread": 0.9, "sprite": "",
		"applies": "burn",
		"desc": "Kjegle av flammer i bevegelsesretningen din. Antenner alt den treffer.",
		"levels": [
			{"desc": "+40 % skade", "damage_mul": 0.40},
			{"desc": "+30 % rekkevidde", "range_mul": 0.30},
			{"desc": "-25 % ladetid", "cooldown_cut": 0.25},
			{"desc": "+50 % skade", "damage_mul": 0.50},
			{"desc": "+40 % rekkevidde", "range_mul": 0.40},
		]},
	"swarm": {
...
const PERKS := [
	...
	{"id": "shock_tag", "name": "Ledende sinn", "desc": "+25 % sjokkskade",
...
const ITEMS := {
	...
	"i_glasscannon": {"name": "Glasshjerte", "kind": "passive", "sprite": "item_glass",
		"desc": "+55 % skade, -30 % maks HP. Alt eller ingenting.",
		"mul": {"damage_mult": 0.55, "max_hp": -0.30}},
	"i_bulwark": {"name": "Skjoldkjerne", "kind": "passive", "sprite": "item_tank",
		"desc": "+45 % maks HP, -20 % skade. Du står stødig.",
		"mul": {"max_hp": 0.45, "damage_mult": -0.20}},
	"i_zerk": {"name": "Vredens merke", "kind": "passive", "sprite": "item_zerk",
		"desc": "+35 % skade så lenge du er under halv HP.",
		"berserk_bonus": 0.35},
	"i_haste": {"name": "Overklokket fjær", "kind": "passive", "sprite": "item_haste",
		"desc": "+35 % skytehastighet, -18 % skade.",
		"mul": {"fire_rate_mult": 0.35, "damage_mult": -0.18}},
	"i_wildfire": {"name": "Villbrann", "kind": "passive", "sprite": "item_wildfire",
		"desc": "+30 % områdestørrelse. Våpen uten egen effekt antenner i stedet.",
