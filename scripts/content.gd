...
const STAGES := [
	{
		"name": "I. Dockside Warehouse",
		"tint": Color(0.10, 0.12, 0.16),
		"boss": "boss_maw",
		"waves": [
			["grunt", 28, 0.6, 0.0],
			["runner", 15, 0.47, 12.0],
	...
	{
		"name": "II. Beneath the Streets",
		"tint": Color(0.12, 0.09, 0.13),
		"boss": "boss_crawler",
		"waves": [
			["runner", 24, 0.4, 0.0],
	...
	{
		"name": "III. Where Geometry Fails",
		"tint": Color(0.09, 0.08, 0.16),
		"boss": "boss_eye",
		"waves": [
			["wretch", 12, 1.07, 0.0],
			["runner", 36, 0.27, 12.0],
